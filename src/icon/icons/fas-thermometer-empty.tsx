...
export const displayName = `${namePrefix}-fas-thermometer-empty`
const svgElement = (
...
const FasThermometerEmpty = createIcon(svgElement)

FasThermometerEmpty.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasThermometerEmpty
