...
export const displayName = `${namePrefix}-far-window-restore`
const svgElement = (
...
const FarWindowRestore = createIcon(svgElement)

FarWindowRestore.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarWindowRestore
