...
export const displayName = `${namePrefix}-fab-asymmetrik`
const svgElement = (
...
const FabAsymmetrik = createIcon(svgElement)

FabAsymmetrik.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabAsymmetrik
