...
export const displayName = `${namePrefix}-fas-fist-raised`
const svgElement = (
...
const FasFistRaised = createIcon(svgElement)

FasFistRaised.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasFistRaised
