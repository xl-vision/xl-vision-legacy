...
export const displayName = `${namePrefix}-fas-holly-berry`
const svgElement = (
...
const FasHollyBerry = createIcon(svgElement)

FasHollyBerry.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHollyBerry
