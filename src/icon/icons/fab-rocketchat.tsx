...
export const displayName = `${namePrefix}-fab-rocketchat`
const svgElement = (
...
const FabRocketchat = createIcon(svgElement)

FabRocketchat.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabRocketchat
