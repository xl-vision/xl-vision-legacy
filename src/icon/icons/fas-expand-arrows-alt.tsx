...
export const displayName = `${namePrefix}-fas-expand-arrows-alt`
const svgElement = (
...
const FasExpandArrowsAlt = createIcon(svgElement)

FasExpandArrowsAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasExpandArrowsAlt
