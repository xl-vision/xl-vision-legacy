...
export const displayName = `${namePrefix}-fab-nintendo-switch`
const svgElement = (
...
const FabNintendoSwitch = createIcon(svgElement)

FabNintendoSwitch.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabNintendoSwitch
