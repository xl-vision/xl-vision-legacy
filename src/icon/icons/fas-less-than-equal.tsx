...
export const displayName = `${namePrefix}-fas-less-than-equal`
const svgElement = (
...
const FasLessThanEqual = createIcon(svgElement)

FasLessThanEqual.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasLessThanEqual
