...
export const displayName = `${namePrefix}-fas-compress-arrows-alt`
const svgElement = (
...
const FasCompressArrowsAlt = createIcon(svgElement)

FasCompressArrowsAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCompressArrowsAlt
