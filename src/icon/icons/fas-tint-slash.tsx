...
export const displayName = `${namePrefix}-fas-tint-slash`
const svgElement = (
...
const FasTintSlash = createIcon(svgElement)

FasTintSlash.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasTintSlash
