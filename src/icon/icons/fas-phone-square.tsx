...
export const displayName = `${namePrefix}-fas-phone-square`
const svgElement = (
...
const FasPhoneSquare = createIcon(svgElement)

FasPhoneSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPhoneSquare
