...
export const displayName = `${namePrefix}-fas-solar-panel`
const svgElement = (
...
const FasSolarPanel = createIcon(svgElement)

FasSolarPanel.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSolarPanel
