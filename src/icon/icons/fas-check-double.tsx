...
export const displayName = `${namePrefix}-fas-check-double`
const svgElement = (
...
const FasCheckDouble = createIcon(svgElement)

FasCheckDouble.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCheckDouble
