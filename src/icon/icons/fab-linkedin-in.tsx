...
export const displayName = `${namePrefix}-fab-linkedin-in`
const svgElement = (
...
const FabLinkedinIn = createIcon(svgElement)

FabLinkedinIn.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabLinkedinIn
