...
export const displayName = `${namePrefix}-fas-draw-polygon`
const svgElement = (
...
const FasDrawPolygon = createIcon(svgElement)

FasDrawPolygon.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasDrawPolygon
