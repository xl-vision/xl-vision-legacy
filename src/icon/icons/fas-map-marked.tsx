...
export const displayName = `${namePrefix}-fas-map-marked`
const svgElement = (
...
const FasMapMarked = createIcon(svgElement)

FasMapMarked.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasMapMarked
