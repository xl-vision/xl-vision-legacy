...
export const displayName = `${namePrefix}-fas-underline`
const svgElement = (
...
const FasUnderline = createIcon(svgElement)

FasUnderline.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUnderline
