...
export const displayName = `${namePrefix}-fab-autoprefixer`
const svgElement = (
...
const FabAutoprefixer = createIcon(svgElement)

FabAutoprefixer.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabAutoprefixer
