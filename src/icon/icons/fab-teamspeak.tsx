...
export const displayName = `${namePrefix}-fab-teamspeak`
const svgElement = (
...
const FabTeamspeak = createIcon(svgElement)

FabTeamspeak.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabTeamspeak
