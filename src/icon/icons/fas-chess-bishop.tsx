...
export const displayName = `${namePrefix}-fas-chess-bishop`
const svgElement = (
...
const FasChessBishop = createIcon(svgElement)

FasChessBishop.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasChessBishop
