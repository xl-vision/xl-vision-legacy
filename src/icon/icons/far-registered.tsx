...
export const displayName = `${namePrefix}-far-registered`
const svgElement = (
...
const FarRegistered = createIcon(svgElement)

FarRegistered.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarRegistered
