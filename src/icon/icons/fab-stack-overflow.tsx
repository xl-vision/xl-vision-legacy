...
export const displayName = `${namePrefix}-fab-stack-overflow`
const svgElement = (
...
const FabStackOverflow = createIcon(svgElement)

FabStackOverflow.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabStackOverflow
