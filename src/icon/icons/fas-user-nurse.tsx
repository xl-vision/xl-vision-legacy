...
export const displayName = `${namePrefix}-fas-user-nurse`
const svgElement = (
...
const FasUserNurse = createIcon(svgElement)

FasUserNurse.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUserNurse
