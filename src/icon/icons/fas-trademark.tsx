...
export const displayName = `${namePrefix}-fas-trademark`
const svgElement = (
...
const FasTrademark = createIcon(svgElement)

FasTrademark.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasTrademark
