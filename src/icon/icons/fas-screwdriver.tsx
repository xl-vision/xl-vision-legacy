...
export const displayName = `${namePrefix}-fas-screwdriver`
const svgElement = (
...
const FasScrewdriver = createIcon(svgElement)

FasScrewdriver.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasScrewdriver
