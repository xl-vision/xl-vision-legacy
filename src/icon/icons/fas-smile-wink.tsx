...
export const displayName = `${namePrefix}-fas-smile-wink`
const svgElement = (
...
const FasSmileWink = createIcon(svgElement)

FasSmileWink.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSmileWink
