...
export const displayName = `${namePrefix}-far-dot-circle`
const svgElement = (
...
const FarDotCircle = createIcon(svgElement)

FarDotCircle.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarDotCircle
