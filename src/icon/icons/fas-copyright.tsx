...
export const displayName = `${namePrefix}-fas-copyright`
const svgElement = (
...
const FasCopyright = createIcon(svgElement)

FasCopyright.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCopyright
