...
export const displayName = `${namePrefix}-fas-battery-three-quarters`
const svgElement = (
...
const FasBatteryThreeQuarters = createIcon(svgElement)

FasBatteryThreeQuarters.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBatteryThreeQuarters
