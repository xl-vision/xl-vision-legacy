...
export const displayName = `${namePrefix}-fas-briefcase-medical`
const svgElement = (
...
const FasBriefcaseMedical = createIcon(svgElement)

FasBriefcaseMedical.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBriefcaseMedical
