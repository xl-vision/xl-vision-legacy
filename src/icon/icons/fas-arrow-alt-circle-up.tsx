...
export const displayName = `${namePrefix}-fas-arrow-alt-circle-up`
const svgElement = (
...
const FasArrowAltCircleUp = createIcon(svgElement)

FasArrowAltCircleUp.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasArrowAltCircleUp
