...
export const displayName = `${namePrefix}-far-file-audio`
const svgElement = (
...
const FarFileAudio = createIcon(svgElement)

FarFileAudio.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarFileAudio
