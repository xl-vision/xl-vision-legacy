...
export const displayName = `${namePrefix}-fas-grip-lines-vertical`
const svgElement = (
...
const FasGripLinesVertical = createIcon(svgElement)

FasGripLinesVertical.displayName = displayName
