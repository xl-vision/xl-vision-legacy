...
export const displayName = `${namePrefix}-fab-shirtsinbulk`
const svgElement = (
...
const FabShirtsinbulk = createIcon(svgElement)

FabShirtsinbulk.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabShirtsinbulk
