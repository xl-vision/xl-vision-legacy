...
export const displayName = `${namePrefix}-far-smile-wink`
const svgElement = (
...
const FarSmileWink = createIcon(svgElement)

FarSmileWink.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarSmileWink
