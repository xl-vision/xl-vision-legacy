...
export const displayName = `${namePrefix}-fas-smile-beam`
const svgElement = (
...
const FasSmileBeam = createIcon(svgElement)

FasSmileBeam.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSmileBeam
