...
export const displayName = `${namePrefix}-fab-cloudsmith`
const svgElement = (
    <svg viewBox='0 0 332 512'>
...
const FabCloudsmith = createIcon(svgElement)

FabCloudsmith.displayName = displayName
