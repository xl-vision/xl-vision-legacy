...
export const displayName = `${namePrefix}-fab-acquisitions-incorporated`
const svgElement = (
...
const FabAcquisitionsIncorporated = createIcon(svgElement)

FabAcquisitionsIncorporated.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabAcquisitionsIncorporated
