...
export const displayName = `${namePrefix}-far-file-video`
const svgElement = (
...
const FarFileVideo = createIcon(svgElement)

FarFileVideo.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarFileVideo
