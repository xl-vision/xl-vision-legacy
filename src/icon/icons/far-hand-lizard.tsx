...
export const displayName = `${namePrefix}-far-hand-lizard`
const svgElement = (
...
const FarHandLizard = createIcon(svgElement)

FarHandLizard.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarHandLizard
