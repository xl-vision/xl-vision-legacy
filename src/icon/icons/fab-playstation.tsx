...
export const displayName = `${namePrefix}-fab-playstation`
const svgElement = (
...
const FabPlaystation = createIcon(svgElement)

FabPlaystation.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabPlaystation
