...
export const displayName = `${namePrefix}-fas-glass-martini-alt`
const svgElement = (
...
const FasGlassMartiniAlt = createIcon(svgElement)

FasGlassMartiniAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasGlassMartiniAlt
