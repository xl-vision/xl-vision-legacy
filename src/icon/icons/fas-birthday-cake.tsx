...
export const displayName = `${namePrefix}-fas-birthday-cake`
const svgElement = (
...
const FasBirthdayCake = createIcon(svgElement)

FasBirthdayCake.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBirthdayCake
