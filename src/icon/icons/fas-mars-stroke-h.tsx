...
export const displayName = `${namePrefix}-fas-mars-stroke-h`
const svgElement = (
...
const FasMarsStrokeH = createIcon(svgElement)

FasMarsStrokeH.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasMarsStrokeH
