...
export const displayName = `${namePrefix}-far-comment-dots`
const svgElement = (
...
const FarCommentDots = createIcon(svgElement)

FarCommentDots.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarCommentDots
