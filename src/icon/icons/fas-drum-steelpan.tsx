...
export const displayName = `${namePrefix}-fas-drum-steelpan`
const svgElement = (
...
const FasDrumSteelpan = createIcon(svgElement)

FasDrumSteelpan.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasDrumSteelpan
