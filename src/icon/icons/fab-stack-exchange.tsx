...
export const displayName = `${namePrefix}-fab-stack-exchange`
const svgElement = (
...
const FabStackExchange = createIcon(svgElement)

FabStackExchange.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabStackExchange
