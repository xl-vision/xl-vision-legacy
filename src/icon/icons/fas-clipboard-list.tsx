...
export const displayName = `${namePrefix}-fas-clipboard-list`
const svgElement = (
...
const FasClipboardList = createIcon(svgElement)

FasClipboardList.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasClipboardList
