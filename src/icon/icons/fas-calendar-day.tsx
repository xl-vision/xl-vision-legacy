...
export const displayName = `${namePrefix}-fas-calendar-day`
const svgElement = (
...
const FasCalendarDay = createIcon(svgElement)

FasCalendarDay.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCalendarDay
