...
export const displayName = `${namePrefix}-fas-level-up-alt`
const svgElement = (
...
const FasLevelUpAlt = createIcon(svgElement)

FasLevelUpAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasLevelUpAlt
