...
export const displayName = `${namePrefix}-far-meh-rolling-eyes`
const svgElement = (
...
const FarMehRollingEyes = createIcon(svgElement)

FarMehRollingEyes.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarMehRollingEyes
