...
export const displayName = `${namePrefix}-fas-chart-area`
const svgElement = (
...
const FasChartArea = createIcon(svgElement)

FasChartArea.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasChartArea
