...
export const displayName = `${namePrefix}-fas-file-export`
const svgElement = (
...
const FasFileExport = createIcon(svgElement)

FasFileExport.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasFileExport
