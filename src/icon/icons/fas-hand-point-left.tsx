...
export const displayName = `${namePrefix}-fas-hand-point-left`
const svgElement = (
...
const FasHandPointLeft = createIcon(svgElement)

FasHandPointLeft.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHandPointLeft
