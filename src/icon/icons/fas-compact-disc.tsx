...
export const displayName = `${namePrefix}-fas-compact-disc`
const svgElement = (
...
const FasCompactDisc = createIcon(svgElement)

FasCompactDisc.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCompactDisc
