...
export const displayName = `${namePrefix}-fas-cash-register`
const svgElement = (
...
const FasCashRegister = createIcon(svgElement)

FasCashRegister.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCashRegister
