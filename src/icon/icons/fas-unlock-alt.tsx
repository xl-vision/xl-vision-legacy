...
export const displayName = `${namePrefix}-fas-unlock-alt`
const svgElement = (
...
const FasUnlockAlt = createIcon(svgElement)

FasUnlockAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUnlockAlt
