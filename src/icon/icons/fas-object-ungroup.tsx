...
export const displayName = `${namePrefix}-fas-object-ungroup`
const svgElement = (
...
const FasObjectUngroup = createIcon(svgElement)

FasObjectUngroup.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasObjectUngroup
