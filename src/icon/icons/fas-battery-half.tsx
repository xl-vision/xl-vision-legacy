...
export const displayName = `${namePrefix}-fas-battery-half`
const svgElement = (
...
const FasBatteryHalf = createIcon(svgElement)

FasBatteryHalf.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBatteryHalf
