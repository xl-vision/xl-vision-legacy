...
export const displayName = `${namePrefix}-far-calendar-minus`
const svgElement = (
...
const FarCalendarMinus = createIcon(svgElement)

FarCalendarMinus.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarCalendarMinus
