...
export const displayName = `${namePrefix}-fas-remove-format`
const svgElement = (
...
const FasRemoveFormat = createIcon(svgElement)

FasRemoveFormat.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasRemoveFormat
