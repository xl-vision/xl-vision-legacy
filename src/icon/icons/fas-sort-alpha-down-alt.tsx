...
export const displayName = `${namePrefix}-fas-sort-alpha-down-alt`
const svgElement = (
...
const FasSortAlphaDownAlt = createIcon(svgElement)

FasSortAlphaDownAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSortAlphaDownAlt
