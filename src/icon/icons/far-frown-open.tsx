...
export const displayName = `${namePrefix}-far-frown-open`
const svgElement = (
...
const FarFrownOpen = createIcon(svgElement)

FarFrownOpen.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarFrownOpen
