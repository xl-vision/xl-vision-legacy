...
export const displayName = `${namePrefix}-fas-temperature-low`
const svgElement = (
...
const FasTemperatureLow = createIcon(svgElement)

FasTemperatureLow.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasTemperatureLow
