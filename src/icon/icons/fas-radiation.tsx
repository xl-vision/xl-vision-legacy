...
export const displayName = `${namePrefix}-fas-radiation`
const svgElement = (
...
const FasRadiation = createIcon(svgElement)

FasRadiation.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasRadiation
