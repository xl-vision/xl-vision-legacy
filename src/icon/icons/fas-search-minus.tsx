...
export const displayName = `${namePrefix}-fas-search-minus`
const svgElement = (
...
const FasSearchMinus = createIcon(svgElement)

FasSearchMinus.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSearchMinus
