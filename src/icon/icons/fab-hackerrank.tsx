...
export const displayName = `${namePrefix}-fab-hackerrank`
const svgElement = (
...
const FabHackerrank = createIcon(svgElement)

FabHackerrank.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabHackerrank
