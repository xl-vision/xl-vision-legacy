...
export const displayName = `${namePrefix}-fas-thumbtack`
const svgElement = (
...
const FasThumbtack = createIcon(svgElement)

FasThumbtack.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasThumbtack
