...
export const displayName = `${namePrefix}-fas-directions`
const svgElement = (
...
const FasDirections = createIcon(svgElement)

FasDirections.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasDirections
