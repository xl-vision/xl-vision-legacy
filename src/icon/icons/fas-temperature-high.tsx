...
export const displayName = `${namePrefix}-fas-temperature-high`
const svgElement = (
...
const FasTemperatureHigh = createIcon(svgElement)

FasTemperatureHigh.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasTemperatureHigh
