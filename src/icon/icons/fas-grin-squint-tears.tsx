...
export const displayName = `${namePrefix}-fas-grin-squint-tears`
const svgElement = (
...
const FasGrinSquintTears = createIcon(svgElement)

FasGrinSquintTears.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasGrinSquintTears
