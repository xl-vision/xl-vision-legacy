...
export const displayName = `${namePrefix}-far-laugh-beam`
const svgElement = (
...
const FarLaughBeam = createIcon(svgElement)

FarLaughBeam.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarLaughBeam
