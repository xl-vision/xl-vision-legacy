...
export const displayName = `${namePrefix}-fas-hand-holding-usd`
const svgElement = (
...
const FasHandHoldingUsd = createIcon(svgElement)

FasHandHoldingUsd.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHandHoldingUsd
