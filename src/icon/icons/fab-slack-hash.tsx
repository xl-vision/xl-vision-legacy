...
export const displayName = `${namePrefix}-fab-slack-hash`
const svgElement = (
...
const FabSlackHash = createIcon(svgElement)

FabSlackHash.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabSlackHash
