...
export const displayName = `${namePrefix}-fab-hacker-news-square`
const svgElement = (
...
const FabHackerNewsSquare = createIcon(svgElement)

FabHackerNewsSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabHackerNewsSquare
