...
export const displayName = `${namePrefix}-fab-cloudscale`
const svgElement = (
...
const FabCloudscale = createIcon(svgElement)

FabCloudscale.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabCloudscale
