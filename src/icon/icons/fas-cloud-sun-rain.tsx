...
export const displayName = `${namePrefix}-fas-cloud-sun-rain`
const svgElement = (
...
const FasCloudSunRain = createIcon(svgElement)

FasCloudSunRain.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCloudSunRain
