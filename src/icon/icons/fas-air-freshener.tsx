...
export const displayName = `${namePrefix}-fas-air-freshener`
const svgElement = (
...
const FasAirFreshener = createIcon(svgElement)

FasAirFreshener.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasAirFreshener
