...
export const displayName = `${namePrefix}-fas-wine-glass`
const svgElement = (
...
const FasWineGlass = createIcon(svgElement)

FasWineGlass.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasWineGlass
