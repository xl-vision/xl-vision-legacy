...
export const displayName = `${namePrefix}-fab-sticker-mule`
const svgElement = (
...
const FabStickerMule = createIcon(svgElement)

FabStickerMule.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabStickerMule
