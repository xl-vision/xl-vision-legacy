...
export const displayName = `${namePrefix}-fas-file-video`
const svgElement = (
...
const FasFileVideo = createIcon(svgElement)

FasFileVideo.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasFileVideo
