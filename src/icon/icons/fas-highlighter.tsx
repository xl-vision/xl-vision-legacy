...
export const displayName = `${namePrefix}-fas-highlighter`
const svgElement = (
...
const FasHighlighter = createIcon(svgElement)

FasHighlighter.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHighlighter
