...
export const displayName = `${namePrefix}-fas-house-damage`
const svgElement = (
...
const FasHouseDamage = createIcon(svgElement)

FasHouseDamage.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHouseDamage
