...
export const displayName = `${namePrefix}-fas-user-times`
const svgElement = (
...
const FasUserTimes = createIcon(svgElement)

FasUserTimes.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUserTimes
