...
export const displayName = `${namePrefix}-fas-cloud-rain`
const svgElement = (
...
const FasCloudRain = createIcon(svgElement)

FasCloudRain.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCloudRain
