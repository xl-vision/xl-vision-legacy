...
export const displayName = `${namePrefix}-fab-fonticons`
const svgElement = (
...
const FabFonticons = createIcon(svgElement)

FabFonticons.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabFonticons
