...
export const displayName = `${namePrefix}-fas-satellite`
const svgElement = (
...
const FasSatellite = createIcon(svgElement)

FasSatellite.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSatellite
