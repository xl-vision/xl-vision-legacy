...
export const displayName = `${namePrefix}-fas-hand-peace`
const svgElement = (
...
const FasHandPeace = createIcon(svgElement)

FasHandPeace.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHandPeace
