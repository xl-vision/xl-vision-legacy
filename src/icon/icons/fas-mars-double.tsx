...
export const displayName = `${namePrefix}-fas-mars-double`
const svgElement = (
...
const FasMarsDouble = createIcon(svgElement)

FasMarsDouble.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasMarsDouble
