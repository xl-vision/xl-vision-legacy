...
export const displayName = `${namePrefix}-fas-hand-spock`
const svgElement = (
...
const FasHandSpock = createIcon(svgElement)

FasHandSpock.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHandSpock
