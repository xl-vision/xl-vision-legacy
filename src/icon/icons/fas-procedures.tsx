...
export const displayName = `${namePrefix}-fas-procedures`
const svgElement = (
...
const FasProcedures = createIcon(svgElement)

FasProcedures.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasProcedures
