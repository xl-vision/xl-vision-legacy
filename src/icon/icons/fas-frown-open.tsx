...
export const displayName = `${namePrefix}-fas-frown-open`
const svgElement = (
...
const FasFrownOpen = createIcon(svgElement)

FasFrownOpen.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasFrownOpen
