...
export const displayName = `${namePrefix}-fab-quinscape`
const svgElement = (
...
const FabQuinscape = createIcon(svgElement)

FabQuinscape.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabQuinscape
