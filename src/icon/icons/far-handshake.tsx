...
export const displayName = `${namePrefix}-far-handshake`
const svgElement = (
...
const FarHandshake = createIcon(svgElement)

FarHandshake.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarHandshake
