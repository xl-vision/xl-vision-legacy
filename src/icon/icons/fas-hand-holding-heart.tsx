...
export const displayName = `${namePrefix}-fas-hand-holding-heart`
const svgElement = (
...
const FasHandHoldingHeart = createIcon(svgElement)

FasHandHoldingHeart.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHandHoldingHeart
