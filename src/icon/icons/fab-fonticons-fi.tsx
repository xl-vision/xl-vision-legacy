...
export const displayName = `${namePrefix}-fab-fonticons-fi`
const svgElement = (
...
const FabFonticonsFi = createIcon(svgElement)

FabFonticonsFi.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabFonticonsFi
