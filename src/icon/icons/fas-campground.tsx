...
export const displayName = `${namePrefix}-fas-campground`
const svgElement = (
...
const FasCampground = createIcon(svgElement)

FasCampground.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCampground
