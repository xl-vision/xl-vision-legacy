...
export const displayName = `${namePrefix}-far-grin-hearts`
const svgElement = (
...
const FarGrinHearts = createIcon(svgElement)

FarGrinHearts.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarGrinHearts
