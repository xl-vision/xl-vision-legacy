...
export const displayName = `${namePrefix}-fas-pause-circle`
const svgElement = (
...
const FasPauseCircle = createIcon(svgElement)

FasPauseCircle.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPauseCircle
