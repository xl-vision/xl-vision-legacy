...
export const displayName = `${namePrefix}-fas-headphones`
const svgElement = (
...
const FasHeadphones = createIcon(svgElement)

FasHeadphones.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHeadphones
