...
export const displayName = `${namePrefix}-fas-step-forward`
const svgElement = (
...
const FasStepForward = createIcon(svgElement)

FasStepForward.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasStepForward
