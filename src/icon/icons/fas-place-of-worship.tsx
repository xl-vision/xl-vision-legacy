...
export const displayName = `${namePrefix}-fas-place-of-worship`
const svgElement = (
...
const FasPlaceOfWorship = createIcon(svgElement)

FasPlaceOfWorship.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPlaceOfWorship
