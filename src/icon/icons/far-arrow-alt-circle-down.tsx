...
export const displayName = `${namePrefix}-far-arrow-alt-circle-down`
const svgElement = (
...
const FarArrowAltCircleDown = createIcon(svgElement)

FarArrowAltCircleDown.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarArrowAltCircleDown
