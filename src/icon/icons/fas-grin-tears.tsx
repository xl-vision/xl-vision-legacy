...
export const displayName = `${namePrefix}-fas-grin-tears`
const svgElement = (
...
const FasGrinTears = createIcon(svgElement)

FasGrinTears.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasGrinTears
