...
export const displayName = `${namePrefix}-fas-phone-square-alt`
const svgElement = (
...
const FasPhoneSquareAlt = createIcon(svgElement)

FasPhoneSquareAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPhoneSquareAlt
