...
export const displayName = `${namePrefix}-fas-battery-quarter`
const svgElement = (
...
const FasBatteryQuarter = createIcon(svgElement)

FasBatteryQuarter.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBatteryQuarter
