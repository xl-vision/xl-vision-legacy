...
export const displayName = `${namePrefix}-fas-weight-hanging`
const svgElement = (
...
const FasWeightHanging = createIcon(svgElement)

FasWeightHanging.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasWeightHanging
