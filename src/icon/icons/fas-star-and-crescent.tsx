...
export const displayName = `${namePrefix}-fas-star-and-crescent`
const svgElement = (
...
const FasStarAndCrescent = createIcon(svgElement)

FasStarAndCrescent.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasStarAndCrescent
