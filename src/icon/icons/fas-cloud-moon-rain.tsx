...
export const displayName = `${namePrefix}-fas-cloud-moon-rain`
const svgElement = (
...
const FasCloudMoonRain = createIcon(svgElement)

FasCloudMoonRain.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCloudMoonRain
