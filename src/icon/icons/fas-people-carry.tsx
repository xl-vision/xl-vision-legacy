...
export const displayName = `${namePrefix}-fas-people-carry`
const svgElement = (
...
const FasPeopleCarry = createIcon(svgElement)

FasPeopleCarry.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPeopleCarry
