...
export const displayName = `${namePrefix}-fas-heart-broken`
const svgElement = (
...
const FasHeartBroken = createIcon(svgElement)

FasHeartBroken.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHeartBroken
