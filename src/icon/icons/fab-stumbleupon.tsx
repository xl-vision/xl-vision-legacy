...
export const displayName = `${namePrefix}-fab-stumbleupon`
const svgElement = (
...
const FabStumbleupon = createIcon(svgElement)

FabStumbleupon.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabStumbleupon
