...
export const displayName = `${namePrefix}-far-laugh-squint`
const svgElement = (
...
const FarLaughSquint = createIcon(svgElement)

FarLaughSquint.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarLaughSquint
