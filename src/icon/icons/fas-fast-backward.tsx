...
export const displayName = `${namePrefix}-fas-fast-backward`
const svgElement = (
...
const FasFastBackward = createIcon(svgElement)

FasFastBackward.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasFastBackward
