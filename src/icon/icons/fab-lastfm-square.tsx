...
export const displayName = `${namePrefix}-fab-lastfm-square`
const svgElement = (
...
const FabLastfmSquare = createIcon(svgElement)

FabLastfmSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabLastfmSquare
