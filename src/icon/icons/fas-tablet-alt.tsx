...
export const displayName = `${namePrefix}-fas-tablet-alt`
const svgElement = (
...
const FasTabletAlt = createIcon(svgElement)

FasTabletAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasTabletAlt
