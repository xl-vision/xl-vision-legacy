...
export const displayName = `${namePrefix}-fas-caret-square-right`
const svgElement = (
...
const FasCaretSquareRight = createIcon(svgElement)

FasCaretSquareRight.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCaretSquareRight
