...
export const displayName = `${namePrefix}-far-address-book`
const svgElement = (
...
const FarAddressBook = createIcon(svgElement)

FarAddressBook.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarAddressBook
