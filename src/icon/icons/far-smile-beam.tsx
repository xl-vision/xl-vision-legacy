...
export const displayName = `${namePrefix}-far-smile-beam`
const svgElement = (
...
const FarSmileBeam = createIcon(svgElement)

FarSmileBeam.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarSmileBeam
