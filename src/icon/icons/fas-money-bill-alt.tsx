...
export const displayName = `${namePrefix}-fas-money-bill-alt`
const svgElement = (
...
const FasMoneyBillAlt = createIcon(svgElement)

FasMoneyBillAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasMoneyBillAlt
