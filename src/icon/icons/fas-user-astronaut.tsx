...
export const displayName = `${namePrefix}-fas-user-astronaut`
const svgElement = (
...
const FasUserAstronaut = createIcon(svgElement)

FasUserAstronaut.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUserAstronaut
