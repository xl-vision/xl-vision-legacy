...
export const displayName = `${namePrefix}-fas-helicopter`
const svgElement = (
...
const FasHelicopter = createIcon(svgElement)

FasHelicopter.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHelicopter
