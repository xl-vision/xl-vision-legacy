...
export const displayName = `${namePrefix}-fab-bimobject`
const svgElement = (
...
const FabBimobject = createIcon(svgElement)

FabBimobject.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabBimobject
