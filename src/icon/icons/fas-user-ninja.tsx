...
export const displayName = `${namePrefix}-fas-user-ninja`
const svgElement = (
...
const FasUserNinja = createIcon(svgElement)

FasUserNinja.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUserNinja
