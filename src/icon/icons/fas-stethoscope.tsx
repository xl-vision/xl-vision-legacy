...
export const displayName = `${namePrefix}-fas-stethoscope`
const svgElement = (
...
const FasStethoscope = createIcon(svgElement)

FasStethoscope.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasStethoscope
