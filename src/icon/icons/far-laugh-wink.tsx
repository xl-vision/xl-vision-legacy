...
export const displayName = `${namePrefix}-far-laugh-wink`
const svgElement = (
...
const FarLaughWink = createIcon(svgElement)

FarLaughWink.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarLaughWink
