...
export const displayName = `${namePrefix}-fas-prescription-bottle`
const svgElement = (
...
const FasPrescriptionBottle = createIcon(svgElement)

FasPrescriptionBottle.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPrescriptionBottle
