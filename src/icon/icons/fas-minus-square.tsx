...
export const displayName = `${namePrefix}-fas-minus-square`
const svgElement = (
...
const FasMinusSquare = createIcon(svgElement)

FasMinusSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasMinusSquare
