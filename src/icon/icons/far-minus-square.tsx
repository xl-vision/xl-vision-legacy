...
export const displayName = `${namePrefix}-far-minus-square`
const svgElement = (
...
const FarMinusSquare = createIcon(svgElement)

FarMinusSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarMinusSquare
