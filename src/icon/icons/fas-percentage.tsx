...
export const displayName = `${namePrefix}-fas-percentage`
const svgElement = (
...
const FasPercentage = createIcon(svgElement)

FasPercentage.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPercentage
