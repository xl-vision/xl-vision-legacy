...
export const displayName = `${namePrefix}-far-grin-squint`
const svgElement = (
...
const FarGrinSquint = createIcon(svgElement)

FarGrinSquint.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarGrinSquint
