...
export const displayName = `${namePrefix}-fas-long-arrow-alt-down`
const svgElement = (
...
const FasLongArrowAltDown = createIcon(svgElement)

FasLongArrowAltDown.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasLongArrowAltDown
