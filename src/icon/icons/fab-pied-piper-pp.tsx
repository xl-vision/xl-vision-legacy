...
export const displayName = `${namePrefix}-fab-pied-piper-pp`
const svgElement = (
...
const FabPiedPiperPp = createIcon(svgElement)

FabPiedPiperPp.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabPiedPiperPp
