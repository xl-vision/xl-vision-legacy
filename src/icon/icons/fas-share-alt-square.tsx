...
export const displayName = `${namePrefix}-fas-share-alt-square`
const svgElement = (
...
const FasShareAltSquare = createIcon(svgElement)

FasShareAltSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasShareAltSquare
