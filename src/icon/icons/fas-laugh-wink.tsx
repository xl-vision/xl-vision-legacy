...
export const displayName = `${namePrefix}-fas-laugh-wink`
const svgElement = (
...
const FasLaughWink = createIcon(svgElement)

FasLaughWink.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasLaughWink
