...
export const displayName = `${namePrefix}-far-file-powerpoint`
const svgElement = (
...
const FarFilePowerpoint = createIcon(svgElement)

FarFilePowerpoint.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarFilePowerpoint
