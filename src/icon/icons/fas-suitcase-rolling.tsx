...
export const displayName = `${namePrefix}-fas-suitcase-rolling`
const svgElement = (
...
const FasSuitcaseRolling = createIcon(svgElement)

FasSuitcaseRolling.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSuitcaseRolling
