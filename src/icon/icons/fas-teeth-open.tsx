...
export const displayName = `${namePrefix}-fas-teeth-open`
const svgElement = (
...
const FasTeethOpen = createIcon(svgElement)

FasTeethOpen.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasTeethOpen
