...
export const displayName = `${namePrefix}-fas-hospital-alt`
const svgElement = (
...
const FasHospitalAlt = createIcon(svgElement)

FasHospitalAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasHospitalAlt
