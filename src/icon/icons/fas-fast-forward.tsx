...
export const displayName = `${namePrefix}-fas-fast-forward`
const svgElement = (
...
const FasFastForward = createIcon(svgElement)

FasFastForward.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasFastForward
