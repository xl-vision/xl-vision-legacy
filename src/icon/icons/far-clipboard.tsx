...
export const displayName = `${namePrefix}-far-clipboard`
const svgElement = (
...
const FarClipboard = createIcon(svgElement)

FarClipboard.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarClipboard
