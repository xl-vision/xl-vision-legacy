...
export const displayName = `${namePrefix}-fas-blender-phone`
const svgElement = (
...
const FasBlenderPhone = createIcon(svgElement)

FasBlenderPhone.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBlenderPhone
