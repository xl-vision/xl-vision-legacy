...
export const displayName = `${namePrefix}-fas-clinic-medical`
const svgElement = (
...
const FasClinicMedical = createIcon(svgElement)

FasClinicMedical.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasClinicMedical
