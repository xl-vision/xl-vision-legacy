...
export const displayName = `${namePrefix}-far-grin-tongue`
const svgElement = (
...
const FarGrinTongue = createIcon(svgElement)

FarGrinTongue.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarGrinTongue
