...
export const displayName = `${namePrefix}-far-grin-tongue-wink`
const svgElement = (
...
const FarGrinTongueWink = createIcon(svgElement)

FarGrinTongueWink.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarGrinTongueWink
