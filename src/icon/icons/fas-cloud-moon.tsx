...
export const displayName = `${namePrefix}-fas-cloud-moon`
const svgElement = (
...
const FasCloudMoon = createIcon(svgElement)

FasCloudMoon.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCloudMoon
