...
export const displayName = `${namePrefix}-fas-sort-amount-up-alt`
const svgElement = (
...
const FasSortAmountUpAlt = createIcon(svgElement)

FasSortAmountUpAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSortAmountUpAlt
