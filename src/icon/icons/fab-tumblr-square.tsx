...
export const displayName = `${namePrefix}-fab-tumblr-square`
const svgElement = (
...
const FabTumblrSquare = createIcon(svgElement)

FabTumblrSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabTumblrSquare
