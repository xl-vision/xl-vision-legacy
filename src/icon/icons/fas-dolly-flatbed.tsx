...
export const displayName = `${namePrefix}-fas-dolly-flatbed`
const svgElement = (
...
const FasDollyFlatbed = createIcon(svgElement)

FasDollyFlatbed.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasDollyFlatbed
