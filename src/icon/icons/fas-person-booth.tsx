...
export const displayName = `${namePrefix}-fas-person-booth`
const svgElement = (
...
const FasPersonBooth = createIcon(svgElement)

FasPersonBooth.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPersonBooth
