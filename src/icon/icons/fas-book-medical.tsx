...
export const displayName = `${namePrefix}-fas-book-medical`
const svgElement = (
...
const FasBookMedical = createIcon(svgElement)

FasBookMedical.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBookMedical
