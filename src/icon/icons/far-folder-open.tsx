...
export const displayName = `${namePrefix}-far-folder-open`
const svgElement = (
...
const FarFolderOpen = createIcon(svgElement)

FarFolderOpen.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarFolderOpen
