...
export const displayName = `${namePrefix}-fas-lightbulb`
const svgElement = (
...
const FasLightbulb = createIcon(svgElement)

FasLightbulb.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasLightbulb
