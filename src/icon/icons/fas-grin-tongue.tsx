...
export const displayName = `${namePrefix}-fas-grin-tongue`
const svgElement = (
...
const FasGrinTongue = createIcon(svgElement)

FasGrinTongue.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasGrinTongue
