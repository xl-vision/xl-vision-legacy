...
export const displayName = `${namePrefix}-fas-utensil-spoon`
const svgElement = (
...
const FasUtensilSpoon = createIcon(svgElement)

FasUtensilSpoon.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUtensilSpoon
