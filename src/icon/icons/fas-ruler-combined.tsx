...
export const displayName = `${namePrefix}-fas-ruler-combined`
const svgElement = (
...
const FasRulerCombined = createIcon(svgElement)

FasRulerCombined.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasRulerCombined
