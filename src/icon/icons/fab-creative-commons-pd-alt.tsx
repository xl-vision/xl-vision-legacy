...
export const displayName = `${namePrefix}-fab-creative-commons-pd-alt`
const svgElement = (
...
const FabCreativeCommonsPdAlt = createIcon(svgElement)

FabCreativeCommonsPdAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabCreativeCommonsPdAlt
