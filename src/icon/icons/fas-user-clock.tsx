...
export const displayName = `${namePrefix}-fas-user-clock`
const svgElement = (
...
const FasUserClock = createIcon(svgElement)

FasUserClock.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUserClock
