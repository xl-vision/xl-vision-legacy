...
export const displayName = `${namePrefix}-fas-battery-full`
const svgElement = (
...
const FasBatteryFull = createIcon(svgElement)

FasBatteryFull.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasBatteryFull
