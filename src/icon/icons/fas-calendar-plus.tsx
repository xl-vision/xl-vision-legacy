...
export const displayName = `${namePrefix}-fas-calendar-plus`
const svgElement = (
...
const FasCalendarPlus = createIcon(svgElement)

FasCalendarPlus.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasCalendarPlus
