...
export const displayName = `${namePrefix}-fas-thermometer-quarter`
const svgElement = (
...
const FasThermometerQuarter = createIcon(svgElement)

FasThermometerQuarter.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasThermometerQuarter
