...
export const displayName = `${namePrefix}-fab-periscope`
const svgElement = (
...
const FabPeriscope = createIcon(svgElement)

FabPeriscope.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabPeriscope
