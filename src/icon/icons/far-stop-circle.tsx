...
export const displayName = `${namePrefix}-far-stop-circle`
const svgElement = (
...
const FarStopCircle = createIcon(svgElement)

FarStopCircle.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FarStopCircle
