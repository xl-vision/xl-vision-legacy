...
export const displayName = `${namePrefix}-fas-strikethrough`
const svgElement = (
...
const FasStrikethrough = createIcon(svgElement)

FasStrikethrough.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasStrikethrough
