...
export const displayName = `${namePrefix}-fab-blackberry`
const svgElement = (
...
const FabBlackberry = createIcon(svgElement)

FabBlackberry.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabBlackberry
