...
export const displayName = `${namePrefix}-fab-xing-square`
const svgElement = (
...
const FabXingSquare = createIcon(svgElement)

FabXingSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabXingSquare
