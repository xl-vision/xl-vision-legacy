...
export const displayName = `${namePrefix}-fas-synagogue`
const svgElement = (
...
const FasSynagogue = createIcon(svgElement)

FasSynagogue.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSynagogue
