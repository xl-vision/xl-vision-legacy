...
export const displayName = `${namePrefix}-fas-plane-departure`
const svgElement = (
...
const FasPlaneDeparture = createIcon(svgElement)

FasPlaneDeparture.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasPlaneDeparture
