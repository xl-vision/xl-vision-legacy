...
export const displayName = `${namePrefix}-fas-chess-knight`
const svgElement = (
...
const FasChessKnight = createIcon(svgElement)

FasChessKnight.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasChessKnight
