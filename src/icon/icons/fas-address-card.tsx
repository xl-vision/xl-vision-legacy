...
export const displayName = `${namePrefix}-fas-address-card`
const svgElement = (
...
const FasAddressCard = createIcon(svgElement)

FasAddressCard.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasAddressCard
