...
export const displayName = `${namePrefix}-fas-chevron-circle-up`
const svgElement = (
...
const FasChevronCircleUp = createIcon(svgElement)

FasChevronCircleUp.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasChevronCircleUp
