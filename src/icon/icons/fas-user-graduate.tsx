...
export const displayName = `${namePrefix}-fas-user-graduate`
const svgElement = (
...
const FasUserGraduate = createIcon(svgElement)

FasUserGraduate.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasUserGraduate
