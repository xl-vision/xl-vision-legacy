...
export const displayName = `${namePrefix}-fas-radiation-alt`
const svgElement = (
...
const FasRadiationAlt = createIcon(svgElement)

FasRadiationAlt.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasRadiationAlt
