...
export const displayName = `${namePrefix}-fas-diagnoses`
const svgElement = (
...
const FasDiagnoses = createIcon(svgElement)

FasDiagnoses.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasDiagnoses
