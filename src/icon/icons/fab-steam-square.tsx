...
export const displayName = `${namePrefix}-fab-steam-square`
const svgElement = (
...
const FabSteamSquare = createIcon(svgElement)

FabSteamSquare.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FabSteamSquare
