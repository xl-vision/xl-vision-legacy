...
export const displayName = `${namePrefix}-fas-sort-numeric-up`
const svgElement = (
...
const FasSortNumericUp = createIcon(svgElement)

FasSortNumericUp.displayName = displayName

export { IconProps } from '../base/createIcon'

export default FasSortNumericUp
