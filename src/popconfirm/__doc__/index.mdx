...
```jsx
import { Popconfirm, Button, Row } from 'xl-vision'
export default () => {
  return (
    <div>
      <Row>
        ...
        <Row.Col span={4}>
          <Popconfirm placement='top-start' content='Are you sure?'>
        ...
        <Row.Col span={4}>
          <Popconfirm placement='top-end' content='Are you sure?'>
      ...
      <Row>
        <Row.Col span={2}></Row.Col>
        <Row.Col span={4}>
          <Popconfirm placement='left-start' content='Are you sure?'>
        ...
        <Row.Col span={4}></Row.Col>
        <Row.Col span={4}>
          <Popconfirm placement='right-start' content='Are you sure?'>
      ...
      <Row>
        <Row.Col span={2}></Row.Col>
        <Row.Col span={4}>
          <Popconfirm placement='left-end' content='Are you sure?'>
        ...
        <Row.Col span={4}></Row.Col>
        <Row.Col span={4}>
          <Popconfirm placement='right-end' content='Are you sure?'>
      ...
      <Row>
        ...
        <Row.Col span={4}></Row.Col>
        <Row.Col span={4}>
          <Popconfirm placement='bottom-start' content='Are you sure?'>
        ...
        <Row.Col span={4}>
          <Popconfirm placement='bottom-end' content='Are you sure?'>
...
::: demo 自定义 icon 自定义 icon

```jsx
import { Popconfirm, Button, Icon } from 'xl-vision'
export default () => {
  return (
    <Popconfirm content='Are you sure?' icon={<Icon.FasSkullCrossbones color='red' />}>
      <Button>click</Button>
    </Popconfirm>
  )
}
