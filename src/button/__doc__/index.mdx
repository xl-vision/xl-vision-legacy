...
export default () => {
  return (
    <div className='wrapper'>
      ...
      <div className='column'>
        <Button prefixIcon={<Icon.Search />}>
          Default
        </Button>
        <Button type='primary' suffixIcon={<Icon.Search />}>
          Primary
        </Button>
        <Button type='success' prefixIcon={<Icon.Search />}>
          Success
        </Button>
        <Button type='warning' prefixIcon={<Icon.Search />}>
          Warning
        </Button>
        <Button type='error' prefixIcon={<Icon.Search />}>
          Error
        </Button>
        <Button type='text' prefixIcon={<Icon.Search />}>
          Text
        </Button>
      </div>
    </div>
